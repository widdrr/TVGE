...
glm::vec3 TVGE::GeometryHelpers::ProjectOnLine(glm::vec3 p_point, glm::vec3 p_end1, glm::vec3 p_end2)
{
...
glm::vec3 TVGE::GeometryHelpers::ProjectOnPlane(glm::vec3 p_point, glm::vec3 p_plane1, glm::vec3 p_plane2, glm::vec3 p_plane3)
{
...
float TVGE::GeometryHelpers::DistanceToPlane(glm::vec3 p_point, glm::vec3 p_planeNormal, float p_planeDistance)
{
	return  glm::dot(p_planeNormal, p_point) - p_planeDistance;
}

glm::vec3 TVGE::GeometryHelpers::GetUpVector(glm::vec3 p_direction)
{
